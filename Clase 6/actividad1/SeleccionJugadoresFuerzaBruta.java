package progra3.clase6.actividad1;

public class SeleccionJugadoresFuerzaBruta {
    ...
    public static void main(String[] args) {
        ...
        Jugador[] jugadores = {
            new Jugador(3, 4),  // Jugador 1
            new Jugador(4, 5),  // Jugador 2
            new Jugador(2, 3)   // Jugador 3
        };
        
        int presupuesto = 6;  // Presupuesto máximo
